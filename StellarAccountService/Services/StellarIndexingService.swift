...
/// The StellarIndexingService maps account effects, transactions and operations together by correlating objects
...
extension StellarIndexingService: StellarAccountServiceDelegate {
    public func accountUpdated(_ service: StellarAccountService,
    ...
    public func accountInactive(_ service: StellarAccountService, account: StellarAccount) {
        // Do nothing
    }
